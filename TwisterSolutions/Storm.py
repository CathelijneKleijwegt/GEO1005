...
class TwisterSolutions:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'TwisterSolutions_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Twister Solutions Storm')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'TwisterSolutions')
        self.toolbar.setObjectName(u'TwisterSolutions')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('TwisterSolutions', message)
    ...
    def unload(self):
        ...
        #print "** UNLOAD TwisterSolutions"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Twister Solutions Storm'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            #print "** STARTING TwisterSolutions"
